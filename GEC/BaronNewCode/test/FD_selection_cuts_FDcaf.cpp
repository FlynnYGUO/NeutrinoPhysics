...
void FD_selection_cuts()
{
  ...
  c->SaveAs("/home/barwu/repos/MuonEffNN/images/FDinND_old_all_hists.png");
  r->SaveAs("/home/barwu/repos/MuonEffNN/images/FDinND_old_all_hists_ratios.png");
  ...
  for (auto& sel:br)
  {
    ...
    cs[i-1]->Update();
    rs[i-1]->Update();
    cs[i-1]->SaveAs(Form("/home/barwu/repos/MuonEffNN/images/FDinND_old_%s_hists.png", dt));
    rs[i-1]->SaveAs(Form("/home/barwu/repos/MuonEffNN/images/FDinND_old_%s_hists_ratios.png", dt));
    i++;
  }
}

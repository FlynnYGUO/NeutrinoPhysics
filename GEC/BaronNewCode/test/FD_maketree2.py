...
def processFiles(f):
    output="/pnfs/dune/scratch/users/baronwu/FDCAFIntegration4GEC_wei/legacy/"+splitext(basename(f))[0]+"_Eff.root"
...
if __name__=="__main__":
    ...
    net.eval()
    hadron_file="/pnfs/dune/persistent/users/baronwu/legacy_splitfiles/legacy_"+argv[1]+"_p?.root"

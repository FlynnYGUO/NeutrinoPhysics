...
void FD_selection_cuts()
{
  ...
  TCanvas *c=new TCanvas("c","Energy Distributions",8000, 4000);
  ...
  gSystem->mkdir(TString::Format("/home/fyguo/testbaroncode/hist_file/0mgsimple_histograms/%.3f_eff_veto_cut_FD", geoeff_cut), kTRUE);

  c->SaveAs(Form("/home/fyguo/testbaroncode/hist_file/0mgsimple_histograms/%0.3f_eff_veto_cut_FD/FD_1760931_less_edge_pos_%0.3f_eff_cut_hists_all.png",geoeff_cut,geoeff_cut));
  r->SaveAs(Form("/home/fyguo/testbaroncode/hist_file/0mgsimple_histograms/%0.3f_eff_veto_cut_FD/FD_1760931_less_edge_pos_%0.3f_eff_cut_hists_ratios.png",geoeff_cut,geoeff_cut));
  ...
  for (auto& sel:br)
  {
    ...
    cs[i-1]->Update();
    rs[i-1]->Update();
    cs[i-1]->SaveAs(Form("/home/fyguo/testbaroncode/hist_file/0mgsimple_histograms/%0.3f_eff_veto_cut_FD/FD_1760931_%s_less_edge_pos_%0.3f_eff_cut_hists.png", geoeff_cut,dt,geoeff_cut));
    rs[i-1]->SaveAs(Form("/home/fyguo/testbaroncode/hist_file/0mgsimple_histograms/%0.3f_eff_veto_cut_FD/FD_1760931_%s_less_edge_pos_%0.3f_eff_cut_hists_ratios.png", geoeff_cut,dt,geoeff_cut));
    i++;
  }
